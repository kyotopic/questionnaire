...
<form action=" {{ route('submit')}}" method="post" accept-charset="UTF-8"
onsubmit="return confirm('您确定提交信息吗？');"
>
    @CSRF
            ...
            <div class="col-lg-12 col-md-12 hidden-sm hidden-xs">
                ...
                <div class="form-check check-box">
                    <input class="form-check-input" type="radio" name="{{ $question->name }}"
                        id="{{ $question->name }}{{ $answer->id }}" value="{{ $answer->id }}" checked>
                            ...
                            <div class="modal-body">
                                <div class="form-check check-box">
                                    <input class="form-check-input" type="radio" name="price{{$question->id}}"
                                        id="{{$question->name}}{{$price->id}}1" value="{{$price->id}}" checked>
