    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-check check-box">
                    <input class="form-check-input" type="radio" name="price3001200" id="price30012002" value="600">
                    <label class="form-check-label form-margin" for="price30012002">
                        ~600元
                    </label>
                </div>
                <div class="form-check check-box">
                    <input class="form-check-input" type="radio" name="price3001200" id="price30012003" value="1200">
                    <label class="form-check-label form-margin" for="price30012003">
                        ~1200元
                    </label>
                </div>
                <div class="form-check check-box">
                    <input class="form-check-input" type="radio" name="price3001200" id="price30012004" value="1201">
                    <label class="form-check-label form-margin" for="price30012004">
                        1200元以上
                    </label>
                </div>
            </div>
...
<div class="modal fade" id="price6002400" tabindex="-1" role="dialog" aria-labelledby="price6002400ModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-check check-box">
                    <input class="form-check-input" type="radio" name="price6002400" id="price60024001" value="600"
                        checked>
                ...
                <div class="form-check check-box">
                    <input class="form-check-input" type="radio" name="price6002400" id="price60024002" value="1200">
                    <label class="form-check-label form-margin" for="price60024002">
                        ~1200元
                    </label>
                </div>
                <div class="form-check check-box">
                    <input class="form-check-input" type="radio" name="price6002400" id="price60024003" value="2400">
                    <label class="form-check-label form-margin" for="price60024003">
                        ~2400元
                    </label>
                </div>
                <div class="form-check check-box">
                    <input class="form-check-input" type="radio" name="price6002400" id="price60024004" value="2401">
...
<!-- Modal 5000-30000 -->
<div class="modal fade" id="price500030000" tabindex="-1" role="dialog" aria-labelledby="price500030000ModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
